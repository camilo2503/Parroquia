...
<div class="col-md-23" >  
		       ...
		       <form accept-charset="UTF-8"  action="consultaCrudServicios" class="simple_form" id="defaultForm2"  method="post">
									...
									<table id="tableEditorial" class="table table-striped table-bordered" >
										<thead>
											...
											<tbody>
												...
												<c:forEach items="${sessionScope.serviciosgenerales}" var="x">
													<tr>
														<td>${x.idserviciosgenerales}</td>
														<td>${x.descripcion}</td>
														<td>${x.monto}</td>
														<td>${x.observaciones}</td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idserviciosgenerales}','${x.descripcion}','${x.monto}','${x.observaciones}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
																<img src='images/edit.gif' width='auto' height='auto' />
															</button>
														</td>
														<td>
															<button type='button' data-toggle='modal' onclick="eliminar('${x.idserviciosgenerales}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		  ...
		  <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					...
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Registro de Servicios Generales</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraActualizaCrudServiciosGenerales" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de Servicios </a></h4>
		                            </div>
		                                ...
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                     ...
		                                     <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_estado" name="monto" placeholder="Ingrese el monto" type="text" maxlength="10"/>
		                                        </div>
		                                    </div>
		                                       <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_reg_estado">Observaciones </label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_observacion" name="observaciones" placeholder="Ingrese la observacion" type="text" maxlength="600"/>
		                                        </div>
		                                    </div>
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Actualiza Servicios</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="registraActualizaCrudServiciosGenerales" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de Servicios Generales</a></h4>
		                            </div>
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idserviciosgenerales" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
		                                     <div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                      ...
		                                      <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_titulo">Observaciones</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_observaciones" name="observaciones" placeholder="Ingrese el precio" type="text" />
		                                        </div>
		                                    </div>  
		                                    <div class="form-group">
		                                        <div class="col-lg-9 col-lg-offset-3">
...
function editar(idserviciosgenerales,descripcion,monto,observaciones){	
	$('input[id=id_ID]').val(idserviciosgenerales);
