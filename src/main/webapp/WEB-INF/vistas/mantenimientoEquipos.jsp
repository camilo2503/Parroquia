...
<h3>Mantenimiento Equipos</h3>
<div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaCrudLibro">
			  		<input type="hidden" id="id_elimina" name="id">
			  </form>	
				
		       <form accept-charset="UTF-8"  action="consultaCrudMantenimientoEquipos" class="simple_form" id="defaultForm2"  method="post">
									...
									<table id="tableEditorial" class="table table-striped table-bordered" >
										<thead>
											...
											<tbody>
												...
												<c:forEach items="${sessionScope.mantenimientoed}" var="x">
													<tr>
													
														<td  style="display: none">${x.idmantenimiento}</td>
														<td>${x.descripcion}</td>
														<td>${x.monto}</td>
														<td>${x.fecharegistro}</td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idmantenimiento}','${x.descripcion}','${x.monto}','${x.fecharegistro}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
																<img src='images/edit.gif' width='auto' height='auto' />
															</button>
														</td>
														<td>
															<button type='button' data-toggle='modal' onclick="eliminar('${x.idmantenimiento}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		  ...
		  <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					...
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Registro de Mantenimiento de Equipos</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraActualizaCrudMantenimientoEquipos" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de Mantenimientos de Equipos</a></h4>
		                            </div>
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Actualiza Mantenimiento Equipos</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action=registraActualizaCrudMantenimientoEquipos class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de Equipos</a></h4>
		                            </div>
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group"  style="display: none">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idmantenimiento" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
		                                     <div class="form-group">
