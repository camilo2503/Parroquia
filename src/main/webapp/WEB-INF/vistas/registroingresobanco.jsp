...
<h3>Registro de Ingresos Bancarios </h3>
<div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaCrudLibro">
			  		<input type="hidden" id="id_elimina" name="id">
			  </form>	
				
		       <form accept-charset="UTF-8"  action="consultaCrudIngresoBancario" class="simple_form" id="defaultForm2"  method="post">
									...
									<table id="tableEditorial" class="table table-striped table-bordered" >
										<thead>
											...
											<tbody>
												...
												<c:forEach items="${sessionScope.ingresobanco}" var="x">
													<tr>
														<td>${x.idingresodinerobanco}</td>
														<td>${x.monto}</td>
														...
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idingresodinerobanco}','${x.monto}','${x.numerooperacion},'${x.comentarios},'${x.fechaingreso}','${x.tipoBanco.idbanco}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
																<img src='images/edit.gif' width='auto' height='auto' />
															</button>
														</td>
														<td>
															<button type='button' data-toggle='modal' onclick="eliminar('${x.idingresodinerobanco}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		  ...
		  <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					...
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Registro de Ingresos bancarios</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraActualizaCrudIngresoBanco" class="form-horizontal"     method="post">
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="registraActualizaCrudIngresoBanco" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idingresodinerobanco" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
...
$.getJSON("listaTipoBanco",{},function(data){
...
function editar(idingresodinerobanco,monto,numerooperacion,comentarios,fechaingreso,idbanco){	
	$('input[id=id_ID]').val(idingresodinerobanco);
