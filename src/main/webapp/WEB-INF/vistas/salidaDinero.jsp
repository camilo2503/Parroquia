...
<div class="col-md-23" >  
		       ...
		       <form accept-charset="UTF-8"  action="consultaCrudsalidaDinero" class="simple_form" id="defaultForm2"  method="post">
									...
									<table id="tableEditorial" class="table table-striped table-bordered" >
										<thead>
											...
											<tbody>
												...
												<c:forEach items="${sessionScope.salidas}" var="x">
													<tr>
														<td>${x.idsalidadinero}</td>
														<td>${x.descripcion}</td>
														<td>${x.monto}</td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idsalidadinero}','${x.descripcion}','${x.monto}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
																<img src='images/edit.gif' width='auto' height='auto' />
															</button>
														</td>
														<td>
															<button type='button' data-toggle='modal' onclick="eliminar('${x.idsalidadinero}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		  ...
		  <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					...
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Registro de Salida de Dinero</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraActualizasalidaDinero" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de Salida </a></h4>
		                            </div>
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action="registraActualizasalidaDinero" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idsalidadinero" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
		                                     <div class="form-group">
...
function editar(idsalidadinero,descripcion,monto){	
	$('input[id=id_ID]').val(idsalidadinero);
