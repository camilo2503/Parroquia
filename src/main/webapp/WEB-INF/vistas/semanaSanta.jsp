...
<div class="col-md-23" >  
			  <form id="idFormElimina" action="eliminaCrudLibro">
		       ...
		       <form accept-charset="UTF-8"  action="consultaCrudSemanaSanta" class="simple_form" id="defaultForm2"  method="post">
									...
									<table id="tableEditorial" class="table table-striped table-bordered" >
										<thead>
											...
											<tbody>
												...
												<c:forEach items="${sessionScope.semanasanta}" var="x">
													<tr>
														<td style="display: none">${x.idsemanasanta}</td>
														<td>${x.descripcion}</td>
														<td>${x.monto}</td>
														<td>${x.observaciones}</td>
														<td>${x.fecharegistro}</td>
														<td>
															<button type='button' data-toggle='modal' onclick="editar('${x.idsemanasanta}','${x.descripcion}','${x.monto}','${x.observaciones}','${x.fecharegistro}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
																<img src='images/edit.gif' width='auto' height='auto' />
															</button>
														</td>
														<td>
															<button type='button' data-toggle='modal' onclick="eliminar('${x.idsemanasanta}');" class='btn btn-success' style='background-color:hsla(233, 100%, 100%, 0);'>
		  ...
		  <div class="modal fade" id="idModalRegistra" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					...
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Registro de Semana santa</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_registra" accept-charset="UTF-8" action="registraActualizaSemanaSanta" class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepOne">Datos de Semana Santa</a></h4>
		                            </div>
		                                ...
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                     ...
		                                     <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_reg_observaciones" name="observaciones" placeholder="Ingrese observaciones"/>
		                                        </div>
		                                    </div>  
		                                       <div class="form-group">
		 ...
		 <div class="modal fade" id="idModalActualiza" >
			<div class="modal-dialog" style="width: 60%">
				...
				<div class="modal-header" style="padding: 35px 50px">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4><span class="glyphicon glyphicon-ok-sign"></span> Actualizacion de Equipos para semana santa</h4>
				</div>
				<div class="modal-body" style="padding: 20px 10px;">
						<form id="id_form_actualiza" accept-charset="UTF-8"  action=registraActualizaSemanaSanta class="form-horizontal"     method="post">
		                    <div class="panel-group" id="steps">
		                        <!-- Step 1 -->
		                        <div class="panel panel-default">
		                            <div class="panel-heading">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group" style="display: none">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idsemanasanta" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
		                                     <div class="form-group">
		                                        <label class="col-lg-3 control-label" for="id_act_codigo">Descripcion</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_codigo" name="descripcion" placeholder="Ingrese la descripcion" type="text" maxlength="600"/>
		                                        </div>
		                                    </div>
		                                  <div class="form-group">
		                                      ...
		                                      <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_observaciones" name="observaciones" placeholder="Ingrese observacion"  />
		                                        </div>
		                                    </div>  
		                                       <div class="form-group" >
		                                        <label class="col-lg-3 control-label" for="id_act_fecha">Fecha de registro</label>
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_fecha" readonly="readonly" name="fecharegistro" placeholder="Ingrese la fecha" type="date"/>
		                                        </div>
		                                    </div>	
		                                    <div class="form-group">
		                                        <div class="col-lg-9 col-lg-offset-3">
...
function editar(idsemanasanta,descripcion,monto,observaciones,fecharegistro){	
	$('input[id=id_ID]').val(idsemanasanta);
	$('input[id=id_act_codigo]').val(descripcion);
	$('input[id=id_act_monto').val(monto);
	$('input[id=id_act_observaciones').val(observaciones);
	$('input[id=id_act_fecha').val(fecharegistro);
